// Package weather implements the fleet's pricing policy.
...
// Decision is the deterministic runway verdict. A model never decides which model to use.
...
// Route sizes a kind of work to a runway.
