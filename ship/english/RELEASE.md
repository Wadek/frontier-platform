...
```text
https://github.com/Wadek/frontier-platform/actions
```
...
```text
https://github.com/Wadek/frontier-platform/releases/tag/v0.1.0-alpha.1
```
...
jobs:
  demo:
    ...
    steps:
      ...
      #       --source-uri github.com/Wadek/frontier-platform \
